  ...
  return (
    <div>
      ...
      <div className="container-fluid px-0" style={{ backgroundColor: "#f4f4f4" }}>
        ...
        <Link to='/chatbot'><input type='image' src='docchatbot1.jpg' border='2px' className="AIBot align-bottom"
        /></Link>
        <div className="mt-5">
          <center>
      ...
      <div className="container-fluid bg-white">
        <div className="row">
          <div className="col-md-6 col1">
            <div className="p1">
              We connect and curate <br />world's healthcare data <br />and make it accessible <br />and useful.
            </div>

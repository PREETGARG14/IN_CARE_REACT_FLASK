    ...
    return (
        ...
        <div className="mainHeading pt-1" style={{ fontFamily: "Arial" }, { fontSize: "14px" }, { fontWeight: "bold" }}>
            ...
            <div className="innerHeading" style={{ paddingTop: "15px" }, { paddingLeft: "15px" }}>
                ...
                <div className="content" style={{ paddingLeft: "15px" }}>
                    ...
                    <div>
                        ...
                        <input type="text" id="Medication item" name="Medication item" onChange={(e)=>{setDetails({...details,"Medication item":e.target.value})}}/>
                    </div>
                    ...
                    <div className="medication">
                        ...
                        <div className="medication-content" style={{ paddingLeft: "15px" }}>
                            <div>
                                ...
                                <input type="text" id="Name" name="Name" onChange={(e)=>{setDetails({...details,"Name":e.target.value})}}/>
                            </div>

                            <div style={{ paddingTop: "5px" }}>
                                <img style={{ height: "20px" }} alt="" className="image" src="item.svg" />
                                <span> Form </span> <span style={{ color: "grey" }, { fontWeight: "bold" }}>[0..*]</span>&nbsp;&nbsp;
                                <input type="text" id="Form" name="Form" onChange={(e)=>{setDetails({...details,"Form":e.target.value})}}/>
                            </div>

                            <div style={{ paddingTop: "5px" }}>
                                <img style={{ height: "20px" }} alt="" className="image" src="q.svg" />
                                <span> Strength </span> &nbsp;&nbsp;
                                <input type="text" id="strength" name="strength" onChange={(e)=>{setDetails({...details,"strength":e.target.value})}}/>&nbsp;&nbsp;
                                <input type="text" id="strengthUnit" name="strengthUnit" placeholder="Unit" onChange={(e)=>{setDetails({...details,"strengthUnit":e.target.value})}}/>
                            </div>
                            ...
                            <div style={{ paddingTop: "5px" }}>
                                ...
                                <div className="diluent-content">
                                    <div>
                                        ...
                                        &nbsp;&nbsp;
                                        <input type="text" id="numerator" name="numerator" placeholder=">=0" onChange={(e)=>{setDetails({...details,"numerator":e.target.value})}}/>
                                        &nbsp;&nbsp;
                                        <input type="text" id="numeratorUnit" name="numeratorUnit" placeholder="unit" onChange={(e)=>{setDetails({...details,"numeratorUnit":e.target.value})}}/>
                                    </div>
                            ...
                            <div style={{ paddingTop: "5px" }}>
                                ...
                                <div className="ingredient-content" style={{ paddingLeft: "15px" }}>
                                    ...
                                    <div style={{ paddingTop: "5px" }}>
                                        ...
                                        <span> Substance name</span>&nbsp;&nbsp;
                                        <input type="text" id="substanceName" name="substanceName" onChange={(e)=>{setDetails({...details,"substanceName":e.target.value})}}/>
                                    </div>

                                    <div style={{ paddingTop: "5px" }}>
                                        <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                                        <span>Form</span> <span style={{ color: "grey" }, { fontWeight: "bold" }}>[0..*]</span>&nbsp;&nbsp;
                                        <input type="text" id="ingredientForm" name="ingredientForm" onChange={(e)=>{setDetails({...details,"ingredientForm":e.target.value})}}/>
                                    </div>

                                    <div style={{ paddingTop: "5px" }}>
                                        <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                                        <span>Category</span> &nbsp;&nbsp;
                                        <input type="text" id="category" name="category" onChange={(e)=>{setDetails({...details,"category":e.target.value})}}/>
                                    </div >

                                    <div style={{ paddingTop: "5px" }}>
                                        <img style={{ height: "20px" }} alt="" src="q.svg" className="image" />
                                        <span>Strength</span> &nbsp;&nbsp;
                                        <input type="text" id="ingredientstrength" name="ingredientStrength" onChange={(e)=>{setDetails({...details,"ingredientstrength":e.target.value})}}/>
                                    </div >

                                    <div style={{ paddingTop: "5px" }}>
                                        <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                                        <span>Strength Unit</span> &nbsp;&nbsp;
                                        <input type="text" id="strengthUnit" name="ingredientStrengthUnit" onChange={(e)=>{setDetails({...details,"strengthUnit":e.target.value})}}/>
                                    </div >

                                    <div style={{ paddingTtop: "5px" }}>
                                        <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                                        <span>Description</span> &nbsp;&nbsp;
                                        <input type="text" id="medicationDescription" name="medicationDescription" onChange={(e)=>{setDetails({...details,"medicationDescription":e.target.value})}}/>
                                    </div>
                                </div>
                            </div >
                        ...
                        <div style={{ paddingTop: "5px" }}>
                            ...
                            <input type="text" id="ingredient-amount" name="ingredient-amount"
                                placeholder=">=0" onChange={(e)=>{setDetails({...details,"ingredient-amount":e.target.value})}}/>&nbsp;&nbsp;
                            <input type="text" id="ingredient-amountUnit" name="ingredient-amountUnit"
                                placeholder="Unit" onChange={(e)=>{setDetails({...details,"ingredient-amountUnit":e.target.value})}}/>
                        </div >
                        ...
                        <div style={{ paddingTop: "5px" }}>
                            ...
                            <select name="roleStatus" id="status" onChange={(e)=>{setDetails({...details,"roleStatus":e.target.value})}}>
                            ...
                            <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                            <input type="text" id="role" name="role" placeholder=">=0" onChange={(e)=>{setDetails({...details,"role":e.target.value})}}/>
                        </div >
                    </div >
                </div >
            ...
            <div style={{ paddingTop: "15px" }, { paddingLeft: "15px" }}>
                ...
                <input type="text" id="route" name="route" onChange={(e)=>{setDetails({...details,"route":e.target.value})}}/>
            </div >
            <br />
            <div style={{ paddingLeft: "15px" }}>
                <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                <span>dosageInstructions</span> &nbsp;&nbsp;
                <input type="text" id="dosageInstructions" name="dosageInstructions" onChange={(e)=>{setDetails({...details,"dosageInstructions":e.target.value})}}/>
            </div >
            ...
            <div style={{ paddingTop: "5px" }, { paddingLeft: "5px" }}>
                    ...
                    <div style={{ paddingTop: "5px" }}>
                        ...
                        <div className="dose-content">
                            ...
                            <div style={{ paddingTop: "5px" }}>
                                ...
                                onChange={(e)=>{setDetails({...details,"doseAmount":e.target.value})}}/>&nbsp;&nbsp;
                                <span>or</span> &nbsp;&nbsp;
                                ...
                                onChange={(e)=>{setDetails({...details,"doseAmountLower":e.target.value})}}/>
    
                                &nbsp;&nbsp;&nbsp;&nbsp;<span>Upper:</span>&nbsp;&nbsp;
                                <input type="text" name="doseAmountUpper" id="doseAmountUpper" placeholder=">=0" 
                                onChange={(e)=>{setDetails({...details,"doseAmountUpper":e.target.value})}}/>
                            </div>

                            <div style={{ paddingTop: "5px" }}>
                                <img style={{ height: "20px" }} alt="" className="image" src='t.svg' />
                                <span>Dose Unit</span> &nbsp;&nbsp;
                                <input type="text" name="doseUnit" id="doseUnit" onChange={(e)=>{setDetails({...details,"doseUnit":e.target.value})}}/>
                            </div>
                            ...
                            <div style={{ paddingTop: "5px" }}>
                                ...
                                <div className="dose-content" style={{ paddingLeft: "15px" }}>
                                    ...
                                    <div style={{ paddingTop: "5px" }}>
                                        ...
                                        <span>frequency</span> &nbsp;&nbsp;
                                        <img style={{ height: "20px" }} alt="" className="image" src="q.svg" />
                                        <input type="text" name="frequency" id="frequency" placeholder="0..1 >=0 >=0 >=0" onChange={(e)=>{setDetails({...details,"frequency":e.target.value})}}/>

                                        &nbsp;&nbsp;
                                        <select name="frequencyUnit" id="status" onChange={(e)=>{setDetails({...details,"frequencyUnit":e.target.value})}}>
                                        ...
                                        onChange={(e)=>{setDetails({...details,"frequencyLower":e.target.value})}}/>

                                        &nbsp;&nbsp;
                                        <select name="frequencyLowerUnit" id="status" onChange={(e)=>{setDetails({...details,"frequencyLowerUnit":e.target.value})}}>
                                            <option value="active">1/d</option>
                                            <option value="stopped">1/min</option>
                                            <option value="neverActive">1/hr</option>
                                            <option value="completed">1/s</option>
                                        ...
                                        <input type="text" name="frequencyUpper" id="frequencyUpper"
                                            placeholder="0..1 >=0 >=0 >=0" onChange={(e)=>{setDetails({...details,"frequencyUpper":e.target.value})}}/>
                                        &nbsp;&nbsp;
                                        <select name="frequencyUpperUnit" id="status" onChange={(e)=>{setDetails({...details,"frequencyUpperUnit":e.target.value})}}>
                                            <option value="active">1/d</option>
                                            <option value="stopped">1/min</option>
                                            <option value="neverActive">1/hr</option>
                                            <option value="completed">1/s</option>
                                    ...
                                    <div style={{ paddingTop: "5px" }}>
                                        ...
                                        <span>Interval</span> &nbsp;&nbsp;
                                        <input type="text" name="interval" id="interval" onChange={(e)=>{setDetails({...details,"interval":e.target.value})}}/>
                                    </div >
                                    ...
                                    <div style={{ paddingTop: "5px" }}>
                                        ...
                                        <input type="time" name="st" id="st" onChange={(e)=>{setDetails({...details,"st":e.target.value})}}/> &nbsp;&nbsp;
                                        <span> or </span> &nbsp;&nbsp;
                                    ...
                                    <div style={{ paddingTop: "5px" }}>
                                        ...
                                        <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                                        <input type="text" name="nte" id="nte" onChange={(e)=>{setDetails({...details,"nte":e.target.value})}}/> &nbsp;&nbsp;
                                        <span>or</span>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <img style={{ height: "20px" }} alt="" src="t_n.svg" className="image" />
                                        <select name="nte2" id="status" onChange={(e)=>{setDetails({...details,"nte2":e.target.value})}}>
                                    ...
                                    <div style={{ paddingTop: "5px" }}>
                                        ...
                                        <input type="checkbox" name="timeCritical" id="timeCritical" onChange={(e)=>{setDetails({...details,"timeCritical":e.target.value})}}/> &nbsp;&nbsp;
                                    </div >

                                    <div style={{ paddingTop: "5px" }}>
                                        <img style={{ height: "20px" }} alt="" src="tick.svg" className="image" />
                                        <span>As required</span> &nbsp;&nbsp;
                                        <input type="checkbox" name="asRequired" id="asRequired" onChange={(e)=>{setDetails({...details,"asRequired":e.target.value})}}/> &nbsp;&nbsp;
                                    </div >

                                    <div style={{ paddingTop: "5px" }}>
                                        <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                                        <span>As required criterion</span> &nbsp;&nbsp;
                                        <input type="text" name="requiredCriterion" id="requiredCriterion" onChange={(e)=>{setDetails({...details,"requiredcriterion":e.target.value})}}/> &nbsp;&nbsp;
                                    </div >
                                ...
                                <div style={{ paddingLeft: "15px" }, { paddingTop: "5px" }}>
                                    ...
                                    <img style={{ height: "20px" }} alt="" src="q.svg" className="image" />
                                    <input type="text" name="iar" id="iar" placeholder="0..1 >=0 >=0 >=0" onChange={(e)=>{setDetails({...details,"iar":e.target.value})}}/>&nbsp;&nbsp;
                                    <select name="iarUnit" id="status" onChange={(e)=>{setDetails({...details,"iarUnit":e.target.value})}}>
                                        <option value="active">1/d</option>
                                        <option value="stopped">1/min</option>
                                        <option value="neverActive">1/hr</option>
                                        <option value="completed">1/s</option>
                                    ...
                                    <span>or</span> &nbsp;&nbsp;
                                    <img style={{ height: "20px" }} alt="" className="image" src="t.svg" />&nbsp;&nbsp;
                                    <input type="text" name="iar1" id="iar1" onChange={(e)=>{setDetails({...details,"iar1":e.target.value})}}/>
                                </div >
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <input type="text" name="administration" id="administration"
                                        placeholder=">=PT0H  D H M S" onChange={(e)=>{setDetails({...details,"administration":e.target.value})}}/>
                                </div >
                            </div >
                        </div >
                        <div style={{ paddingTop: "5px" }}>
                            ...
                            <img style={{ height: "20px" }} alt="" className="image" src="t.svg" />
                            <select name="directionDuration" id=" status" onChange={(e)=>{setDetails({...details,"directionDuration":e.target.value})}}>
                            ...
                            <input type="text" name="directionDuration2" id="directionDuration"
                                placeholder=">=PT0S" onChange={(e)=>{setDetails({...details,"directionDuration2":e.target.value})}}/>
                        </div >
                            ...
                            <div className="direction-repetition-content" style={{ paddingLeft: "15px" }}>
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <input type="text" name="repetitionInterval" id="repetitionInterval"
                                        placeholder=">=POW   Y M W D" onChange={(e)=>{setDetails({...details,"repetitionInterval":e.target.value})}}/>
                                </div>
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <span style={{ color: "grey" }, { fontWeight: "bold" }}> [0..*]</span>&nbsp;&nbsp;
                                    <input type="date" name="specificDate" id="specificDate" onChange={(e)=>{setDetails({...details,"specificDate":e.target.value})}}/>&nbsp;&nbsp;
                                    <input type="time" name="specficTime" onChange={(e)=>{setDetails({...details,"specificTime":e.target.value})}}/>
                                </ div>
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <input type="text" name="specificDayofweek" id="specificDayofweek"
                                        placeholder="0..6" onChange={(e)=>{setDetails({...details,"specificDayofweek":e.target.value})}}/>
                                </div >
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <input type="text" name="specificDayofmonth" id="specificDayofweek"
                                        placeholder="1..31" onChange={(e)=>{setDetails({...details,"specificdayofmonth":e.target.value})}}/>
                                </div >
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <div className="specific-event-content">
                                        ...
                                        <div style={{ paddingTop: "5px" }}>
                                            ...
                                            <input type="text" name="eventName" id="eventName" onChange={(e)=>{setDetails({...details,"eventName":e.target.value})}}/>
                                        </div>
                                        ...
                                        <div style={{ paddingTop: "5px" }}>
                                            ...
                                            <input type="text" name="eventStartInterval" id="specificDayofweek"
                                                placeholder="Y M W D" onChange={(e)=>{setDetails({...details,"eventStartInterval":e.target.value})}}/>
                                        </div >
                ...
                <div style={{ paddingLeft: "15px" }}>
                    ...
                    <div className="medication-safety-content" style={{ paddingLeft: "15px" }}>
                        ...
                        <div style={{ paddingTop: "5px" }}>
                            ...
                            <div className="medication-safety-content">
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <input type="text" id="maximumAmount" name="maximumAmount"
                                        placeholder=">=0" onChange={(e)=>{setDetails({...details,"maximumAmount":e.target.value})}}/>
                                </div>
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    onChange={(e)=>{setDetails({...details,"maximumAmountDoseUnit":e.target.value})}}/>
                                </div>
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <input type="text" id="allowedPeriod" name="allowedPeriod"
                                        placeholder=">=PTOS" onChange={(e)=>{setDetails({...details,"allowedPeriod":e.target.value})}}/>
                                </div >
                            ...
                            <div style={{ paddingTop: "5px" }}>
                                ...
                                <input type="text" id="overrideReason" name="overrideReason" onChange={(e)=>{setDetails({...details,"overrideReason":e.target.value})}}/>
                            </div >
                    ...
                    <div style={{ paddingTop: "5px" }}>
                        <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                        <span>reason</span> &nbsp;&nbsp;
                        <input type="text" id="reason" name="reason" onChange={(e)=>{setDetails({...details,"reason":e.target.value})}}/>
                    </div >
                    ...
                    <div>
                        ...
                        <div className="order-details-content" style={{ paddingLeft: "15px" }}>
                            ...
                            <div style={{ paddingTop: "5px" }}>
                                ...
                                onChange={(e)=>{setDetails({...details,"dateDiscontinued":e.target.value})}}/>&nbsp;&nbsp;
                                <input type="time" id="timeDiscontinued" name="timeDiscontinued" 
                                onChange={(e)=>{setDetails({...details,"timeDiscontinued":e.target.value})}}/>&nbsp;&nbsp;
                            </div >
                            ...
                            <div style={{ paddingTop: "5px" }}>
                                ...
                                onChange={(e)=>{setDetails({...details,"dateWritten":e.target.value})}}/>&nbsp;&nbsp;
                                <input type="time" id="timeWritten" name="timeWritten" 
                                onChange={(e)=>{setDetails({...details,"timeWritten":e.target.value})}}/>&nbsp;&nbsp;
                            </div >
                    ...
                    <div style={{ paddingTop: "5px" }}>
                        ...
                        <div className="authorization-details-content" style={{ paddingLeft: "15px" }}>
                            ...
                            <div style={{ paddingTop: "5px" }}>
                                ...
                                onChange={(e)=>{setDetails({...details,"nora":e.target.value})}}/>
                            </div>
                            ...
                            <div style={{ paddingTop: "5px" }}>
                                ...
                                onChange={(e)=>{setDetails({...details,"validityPeriod":e.target.value})}}/>&nbsp;&nbsp;
                                <input type="time" id="validityPeriodTime" name="validityPeriod" 
                                onChange={(e)=>{setDetails({...details,"validityPeriodTime":e.target.value})}}/>&nbsp;&nbsp;
                            </div >
                            ...
                            <div className="dispense-directions-content" style={{ paddingLeft: "15px" }}>
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <span>Dispense Instructions</span><span
                                        style={{ color: "grey" }, { fontWeight: "bold" }}> [0..*]</span> &nbsp;&nbsp;
                                    <input type="text" name="dispenseInstructions" id="dispenseInstructions" onChange={(e)=>{setDetails({...details,"dispenseInstructions":e.target.value})}}/>
                                </div >
                                ...
                                <div style={{ paddingTop: "5px" }}>
                                    ...
                                    <div className="dispense-directions-content">
                                        ...
                                        <div style={{ paddingTop: "5px" }}>
                                            ...
                                            onChange={(e)=>{setDetails({...details,"amountDescription":e.target.value})}}/>
                                        </div>
                                        ...
                                        <div style={{ paddingTop: "5px" }}>
                                            ...
                                            <input type="text" name="amountindispense" id="amountindispense"
                                                placeholder=">=0" onChange={(e)=>{setDetails({...details,"amountindispense":e.target.value})}}/>
                                        </div >
                                        ...
                                        <div style={{ paddingTop: "5px" }}>
                                            ...
                                            <input type="text" name="dispenseUnits"
                                                id="dispenseInstructions" onChange={(e)=>{setDetails({...details,"dispenseUnits":e.target.value})}}/>
                                        </div >
                                        ...
                                        <div style={{ paddingTop: "5px" }}>
                                            ...
                                            <input type="text" name="dos" id="dos"
                                                placeholder=">=POD  Y M W D S" onChange={(e)=>{setDetails({...details,"dos":e.target.value})}}/>
                                        </div >
                                    </div >
                        ...
                        <div style={{ paddingTop: "5px" }}>
                            <img style={{ height: "20px" }} alt="" src="t.svg" className="image" />
                            <span>Comment</span> &nbsp;&nbsp;
                            <input type="text" name="comment" id="comment" onChange={(e)=>{setDetails({...details,"comment":e.target.value})}}/>
                        </div >

                        <div style={{ paddingTop: "5px" }}>
                            <img style={{ height: "20px" }} alt="" src="id.svg" className="image" />
                            <span>identifier</span> &nbsp;&nbsp;
                            <input type="text" name="identifier" id="identifier" onChange={(e)=>{setDetails({...details,"identifier":e.target.value})}}/>
                        </div >

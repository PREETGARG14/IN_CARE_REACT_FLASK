...
def add_prescription():
    ...
    if request.method == 'POST':
        ...
        ingredientStrengthUnit=request.form.get('ingredientStrengthUnit')
        ingredientDescription=request.form.get('description')
        ...
        doseSpecificTime=request.form.get('time')
        doseNamedTimeEvent=request.form.get('namedTimeEvent')
        doseExactTimingCritical=request.form.get('timeCritical')
        doseAsRequired=request.form.get('required')
        doseAsRequiredCriterion=request.form.get('criterion')
        infusionAdminRateQ=request.form.get('prescriptionID')
        infusionAdminRateUnit=request.form.get('prescriptionID')
        infusionAdminRateT=request.form.get('administration')
        doseAdminDuration=request.form.get('doseAdministration')
        ...
        safetyMaxAmountUnit=request.form.get('maximumAmountUnit')

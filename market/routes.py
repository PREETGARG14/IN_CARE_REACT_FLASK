...
@app.route("/api/prescribeSuccess", methods=["GET", "POST"])
def add_prescription():
    
    if request.method == 'POST':
        pid=request.form.get('pi')
        ...
        ingredientRole2=request.form.get('role')

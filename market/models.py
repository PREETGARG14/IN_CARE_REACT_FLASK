...
#     medStrengthNumerator=db.Column(db.String(), nullable=False)
#     medStrengthNumeratorUnit=db.Column(db.String(length=2), nullable=False)
#     medStrengthDenominator=db.Column(db.String(), nullable=False)
...
#     medAmount=db.Column(db.String(), nullable=False)
#     medAmountUnit=db.Column(db.String(length=2), nullable=False)
#     medAlternateAmount=db.Column(db.String(), nullable=True)
...
#     medDoseAmount=db.Column(db.String(), nullable=False)
#     medDoseAmountLower=db.Column(db.String(), nullable=True)
#     medDoseAmountUpper=db.Column(db.String(), nullable=True)
...
#     medFrequency=db.Column(db.String(), nullable=False)
#     medFrequencyUnit=db.Column(db.String(), nullable=False)
#     medFrequencyLower=db.Column(db.String(), nullable=True)
#     medFrequencyUnitLower=db.Column(db.String(), nullable=True)
#     medFrequencyUpper=db.Column(db.String(), nullable=True)
...
#     medRepetitions=db.Column(db.String(), nullable=True)
#     medAdminRoute=db.Column(db.String(), nullable=True)
#     medTimeRepInterval= db.Column(db.String(), nullable=True)
#     medNonDailyFrequency=db.Column(db.String(), nullable=True)
#     medNonDailyUnit=db.Column(db.String(), nullable=True)
#     medNonDailyLowerFrequency=db.Column(db.String(), nullable=True)
#     medNonDailyLowerUnit=db.Column(db.String(), nullable=True)
#     medNonDailyUpperFrequency=db.Column(db.String(), nullable=True)
...
#     # medNonDailyDoM=db.column(db.String(), nullable=True)
#     # medNonDailyDoMLower=db.column(db.String(), nullable=True)
#     # medNonDailyDoMUpper=db.column(db.String(), nullable=True)
...
#     # medNonDailyRepetitions=db.column(db.String(), nullable=True)

...
class medSummary(db.Model):
    ...
    medExpiry=db.Column(db.String(), nullable=False)
    ...
    medFrequencyInterval=db.Column(db.String(), nullable=False)
    medDailyTime=db.Column(db.String(), nullable=False)
    medDailyimeLower=db.Column(db.String(), nullable=True)
    medDailyTimeUpper=db.Column(db.String(), nullable=True)
    ...
    # medNonDailyDate=db.column(db.String(), nullable=True)
    ...
    # medNonDailyTimeOffset=db.column(db.String(), nullable=True)
    # medNonDailyOn=db.column(db.String(), nullable=True)
    # medNonDailyOff=db.column(db.String(), nullable=True)
